...
while(1) {
	HAL_GPIO_WritePin(GPIOC, GPIO_PIN_1|GPIO_PIN_3|GPIO_PIN_4|GPIO_PIN_6, GPIO_PIN_SET);
	HAL_GPIO_WritePin(GPIOC, GPIO_PIN_0|GPIO_PIN_2|GPIO_PIN_5|GPIO_PIN_7, GPIO_PIN_RESET);
	HAL_Delay(500); // 500 ms ??
	
	HAL_GPIO_WritePin(GPIOC, GPIO_PIN_0|GPIO_PIN_2|GPIO_PIN_5|GPIO_PIN_7, GPIO_PIN_SET);
